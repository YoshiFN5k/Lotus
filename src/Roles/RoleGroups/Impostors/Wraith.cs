...
public class BountyHunter: Impostor
{
    ...
    {
        PlayerControl? BountyHunter = Players.FindPlayerById(Target);
        if (BountyHunter == null) return "";
    ...
    protected override GameOptionBuilder RegisterOptions(GameOptionBuilder optionStream) =>
        base.RegisterOptions(optionStream)
            ...
            .SubOption(sub => sub
                ...
                .Build())
            .SubOption(sub =>  sub
                .name("Arrow to target")
                .AddOnOffValues()
                .BindBool(b => Targetarrow = b)
                .Build());
}