...
using static Lotus.Roles.RoleGroups.Impostors.Disruptor.DisruptorTranslations.DisruptorOptionTranslations;

namespace Lotus.Roles.RoleGroups.Impostors;

public class Disruptor : Impostor
{
    ...
    [Localized(nameof(Disruptor))]
    internal static class DisruptorTranslations
    {
        [Localized(ModConstants.Options)]
        internal static class DisruptorOptionTranslations
        {
